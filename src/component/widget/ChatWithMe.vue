<template>
  <div class="w-full max-w-2xl rounded-2xl bg-gray-50 p-6 shadow flex flex-col gap-6 justify-center mt-10">
    ...
    <!-- Input bar -->
    <form @submit.prevent="sendMessage" class="flex items-center gap-3 bg-white rounded-full px-4 py-2 shadow-inner">
      ...
      <!-- telegram icon-->
      <a class="text-gray-400 hover:text-gray-600 -rotate-40 pb-2" href="https://t.me/daohoang2911"
              target="_blank"
...
const fixedConversation = [
  ...
  { from: 'Dylan', text: "see more in me on telegram/@daohoang2911 or mmhh... on this way ^^" }
]
...
function sendMessage() {
  ...
  input.value = ''
  // Autoreply after a short delay if next message exists
